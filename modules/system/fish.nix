    ...
    programs = {
      ...
      fish = {
        ...
        shellAliases = {
          ...
          prarie = "sudo borg create -s --progress /mnt/prarie::prarie-$(date) /run/media/sumee/emerald/";
          grass = "sudo borg create -s --progress /mnt/grass::grass-$(date) /var/lib/2fauth /var/lib/private/anki-sync-server /var/lib/davis /var/lib/hass /var/lib/postgresql";
        };
