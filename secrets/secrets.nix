...
in {
  "secret1.age".publicKeys = hosts.nahida ++ hosts.verdure;
  "secret2.age".publicKeys = hosts.nahida;
  "secret3.age".publicKeys = hosts.nahida;
  "secret4.age".publicKeys = hosts.nahida ++ hosts.verdure;
  "secret5.age".publicKeys = hosts.kaolin ++ hosts.nahida;
  "secret6.age".publicKeys = users.sumee ++ hosts.nahida;
}
